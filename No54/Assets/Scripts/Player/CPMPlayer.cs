...
public class CPMPlayer : MonoBehaviour
{
    ...
    private void Update()
    {
        yMouseSensitivity = SettingsSingleton.instance.sensitivity;
        xMouseSensitivity = SettingsSingleton.instance.sensitivity;
        if (Death.playerDead || PlayerPaused.Paused || CutScenePlaying.cutscenePlaying)
            return;
        // Do FPS calculation
        frameCount++;
        dt += Time.deltaTime;
